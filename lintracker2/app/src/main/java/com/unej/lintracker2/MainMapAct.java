 ...
 */
public class MainMapAct extends AppCompatActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(@NonNull MapboxMap mapboxMap) {
        ...
        mapboxMap.setStyle(Style.DARK, new Style.OnStyleLoaded() {
            ...
            public void onStyleLoaded(@NonNull Style style) {
                ...
                initRecyclerView();
                Toast.makeText(MainMapAct.this, R.string.toast_instruction, Toast.LENGTH_SHORT).show();
            }
        });
    }
...
//            TextView numOfBeds;
            ...
            MyViewHolder(View view) {
                ...
                pilih_halte = view.findViewById(R.id.pilih_halte);
